...
const CatalogueScreen = lazy(() => import('./features/catalogue/screen/catalogue-screen.tsx').then((m) => ({ default: m.CatalogueScreen })));
const WordBankScreen = lazy(() => import('./features/word-bank/screen/word-bank-screen.tsx').then((m) => ({ default: m.WordBankScreen })));
const HistoryScreen = lazy(() => import('./features/history/screen/history-screen.tsx').then((m) => ({ default: m.HistoryScreen })));
const HistoryDetailScreen = lazy(() => import('./features/history/screen/history-detail-screen.tsx').then((m) => ({ default: m.HistoryDetailScreen })));
