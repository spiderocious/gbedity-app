...
// COUNTDOWN — the 3·2·1 beat before a round. A big numeral pops on each tick (re-animates when
// `count` changes) over the green slide, with a tick cue. At 0 the caller swaps in the round.

interface CountdownScreenProps {
  readonly count: number; // 3 → 2 → 1 (0 hands off to the round)
}
